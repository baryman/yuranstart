                ...
                <div class="medium-6 small-12 columns">
                    <div class="widget-table-action base-settings">
                        ...
                        <ul class="list-option">
                            <li><span>Ширина:</span> <input type="text" name="width" value="" placeholder="Если пусто, то растянется"> px</li>
                            <li><span>Высота:</span> <input type="text" name="height" value="" placeholder="Если пусто, то растянется"> px</li>
                            <li><span>Скорость смены слайдов:</span> <input type="text" name="speed" value="2000"> ms</li>
                            <li><span>Пауза:</span> <input type="text" name="pause" value="1500"> ms</li>
