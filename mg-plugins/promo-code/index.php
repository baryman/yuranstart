...
class PromoCode {
  ...
  static function handleShortCode() {    
    ...
    <form action="'.SITE.'/cart" method="post" class="promo-form">
      <span>Промокод:</span>
      <input type="text" class="input-coupon" name="couponCode"  value = "'.(!empty($_SESSION['couponCode'])? $_SESSION['couponCode'] : '' ).'"/>
