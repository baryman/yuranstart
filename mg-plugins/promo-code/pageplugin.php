...
<div class="section-<?php echo $pluginName ?>"><!-- $pluginName - задает название секции для разграничения JS скрипта -->
  ...
  <div class="reveal-overlay" style="display:none;">
    <div class="reveal xssmall" id="promo-modal" style="display:block;"><!-- блок для контента модального окна -->
      ...
      <div class="reveal-body"><!-- Содержимое окна, управляющие элементы -->       
        <div class="block-for-form" >
          <ul class="custom-form-wrapper fields-calback">
            <li>
              <span style="float: left;">Промокод</span> <input type="text" name="code" value=""/>              
            </li>
            <li>
              <span style="float: left;">Процент скидки</span> <input type="text" name="percent" value=""/>              
            </li>      
            <li>
              <span style="float: left;">Нижняя граница</span> <input type="text" name="from_datetime" value=""/>              
            </li>
            <li>
              <span style="float: left;">Верхняя граница</span> <input type="text" name="to_datetime" value=""/>              
            </li>            
            <li>
      ...
      <button class="save-button tool-tip-bottom button success" data-id="" title="<?php echo $lang['SAVE_MODAL'] ?>"><!-- Кнопка действия -->
          <i class="fa fa-floppy-o"><span><?php echo $lang['SAVE_MODAL'] ?></span></i>
        </button>
        <div class="clear"></div>
      </div>
    </div>
  ...
  <div class="widget-table-body">
     ...
     <div class="widget-table-action">
        <a href="javascript:void(0);" class="add-new-button tool-tip-top " title=""> <button class="button primary"><span><?php echo $lang['ADD_NEW_PROMO'];?></span></button></a>
        <a href="javascript:void(0);" class="show-filters tool-tip-top" title="<?php echo $lang['T_TIP_SHOW_FILTER'];?>"><button class="button primary"><span><?php echo $lang['FILTER'];?></span></button></a>
                      ...
                      <td class="actions">
                        <ul class="action-list"><!-- Действия над записями плагина -->
                          <li class="edit-row" 
                            ...
                            <a class="tool-tip-bottom fa fa-edit" href="javascript:void(0);" 
