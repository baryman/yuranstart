...
<div class="form-wrapper">
  <img src="/uploads/logotip.png" />
  <br />
  <strong><?php echo $data['propertyOrder']['nameyur']?></strong> / YURAN.SU - продажа товаров для рыбалки и туризма в Москве <br />
  ...
  <strong>Товарный чек № <?php echo $data['order']['id']?> от <?php echo $data['order']['updata_date']?></strong>
  <br />
  <br />
  <br/>  
  <table class="form-table">
    ...
    }elseif($data['order']['delivery_cost']==0){
