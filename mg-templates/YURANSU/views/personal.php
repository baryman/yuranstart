...
switch($data['status']){
  ...
  case 3: $userInfo = $data['userInfo']
    ...
    <div class="person-page">
      <p class="custom-text">Приветствуем Вас в своем личном кабинете у нас в интернет-магазине YURAN.SU!
        					В своем личном кабинете Вы сможете следить за статусами Ваших заказов, а так же изменять свои личные данные.</p>
        <p class="custom-text">Вот небольшой список страниц, с которыми мы бы хотели вас ознакомить:</p>
        					<ul class="custom-text">
                              <li><a href="/contacts">Контакты с нами</a> (Местоположение нашего магазина);</li>
                                <li><a href="/dostavka">Доставка и оплата заказов</a></li>
      						</ul>
      ...
      <div class="personal-tabs">
        <ul class="personal-tabs-list">
          ...
          <li><a href="#order-track">Отслеживание отправлений</a></li>
        </ul>
          ...
          <?php endif; ?>
                  ...
                  <div class="order-total">
                    <ul class="total-list">
                      ...
                      <?php endif; ?>
                      <li>Итого: <span class="total-summ"><?php echo MG::numberFormat($order['summ']).'  '.$perCurrencyShort ?></span></li>
                      ...
                      <li>Оплата: <span class="paymen-name-to-history"><?php echo $order['name'] ?></span></li>
                        ...
                        <?php if($order['delivery_cost']): ?><li>Стоимость доставки : <span class="delivery-price"><?php echo MG::numberFormat($order['delivery_cost']).'  '.$perCurrencyShort; ?></span></li>
                        <?php endif; ?>
                      <li>Всего к оплате: <span class="total-order-summ"><?php echo MG::numberFormat($totSumm).'  '.$perCurrencyShort; ?></span></li>
                    </ul>
                  </div>
                  <div class="clear"></div>
        ...
        <div id="order-track" style="height:500px;">
          <p>Отслживание состояния посылок</p>
          <div class="post2go-button"></div>
        </div>
      </div>
    </div>
    <?php
  ...
  default :
    ?>
    <div class="msgError">Личный кабинет доступен только авторизованным пользователям!</div>
<?php } ?> <!-- endswitch -->
