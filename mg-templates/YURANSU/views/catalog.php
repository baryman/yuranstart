   ...
   <div class="form-group">    
    ...
    <?php foreach($data['items'] as $item): ?>		
      <div class="product-wrapper">
        ...
        <?php endif; ?>
          <div class="product-code">Артикул: <span class="code"><?php echo $item["code"] ?></span></div>
        </div>
    ...
    <?php if (URL::isSection('catalog')||(((MG::getSetting('catalogIndex')=='true') && (URL::isSection('index') || URL::isSection(''))))): ?> 
          <div class="cat-desc-text"><?php echo $data['cat_desc'] ?></div>
        <?php endif;?>
    <?php if($cb = str_replace("&nbsp;", "", $data['cat_desc_seo'])): ?><div class="cat-desc-text seo"><?php echo $data['cat_desc_seo'] ?></div><?php endif;?>
   <!-- Верстка поиска -->
<?php else: ?>
    ...
    <?php foreach($data['items'] as $item): ?>
      <div class="product-wrapper">
        ...
        <div class="product-footer">
          ...
          <div class="countViews"><i class="fa fa-eye" aria-hidden="true"></i> <?php echo $item['count_views'];?></div>
