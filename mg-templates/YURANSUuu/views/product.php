...
<div class="product-details-block" itemscope itemtype="http://schema.org/Product">
  ...
  <div class="product-details-wrapper">
    ...
    <div class="product-tabs-container">
      ...
      <div id="tab3"><h2>Способы оплаты</h2><ol><li>Наличными курьеру (в пределах Москвы)</li><li>Перевод средств на карту Сбербанка</li><li>WebMoney</li><li>Яндекс.Деньги</li></ol></div>
      <?php foreach ($data['thisUserFields'] as $key => $value) {
