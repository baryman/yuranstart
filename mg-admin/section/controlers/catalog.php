...
$this->itemsCount = $catalog['totalCountItems'];
//категории:
...
if(isset($_POST['displayFilter'])) {
  $this->displayFilter = ($_POST['cat_id']!="null"&&!empty($_POST['cat_id']))||isset($_POST['displayFilter'])||isset($_POST['applyFilter']); // так проверяем произошёл ли запрос по фильтрам или нет
}
