...
$property = array(
  'email' => array(
    ...
    'label' => 'Email',
    'special' => 'like',
    'value' => !empty($_POST['email'][0]) ? $_POST['email'][0] : null,
  ),
  'phone' => array(
    'type' => 'text',
    'label' => $lang['USER_PHONE'],
    'special' => 'like',
    'value' => !empty($_POST['phone'][0]) ? $_POST['phone'][0] : null,
  ),
   'name' => array(
    'type' => 'text',
    'label' => $lang['USER_NAME'],
    'special' => 'like',
    'value' => !empty($_POST['name'][0]) ? $_POST['name'][0] : null,
  ),
  'sname' => array(
    'type' => 'text',
    'label' => $lang['USER_SNAME'],
    'special' => 'like',
    'value' => !empty($_POST['sname'][0]) ? $_POST['sname'][0] : null,
  ),
  'date_add' => array(
...
$this->displayFilter = ($_POST['role'] != "null" && !empty($_POST['role'])) || isset($_POST['applyFilter']); // так проверяем произошёл ли запрос по фильтрам или нет
$this->filter = $filter->getHtmlFilterAdmin();
