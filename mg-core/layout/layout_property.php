      ...
      <?php if ($data['ajax']) {
        ...
        <?php } else { ?>
          ...
          <a class = "<?php echo $data['classForButton'] ?>" 
             ...
             data-item-id="<?php echo $data['id'] ?>" rel="nofollow">
        ...
        <?php if ($data['printCompareButton'] == 'true') { ?>
          ...
          <a href="<?php echo SITE.'/compare?inCompareProductId='.$data['id'] ?>" rel="nofollow" data-item-id="<?php echo $data['id'] ?>" class="addToCompare" >
