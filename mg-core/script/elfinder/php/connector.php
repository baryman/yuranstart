...
if($_REQUEST['dir']=='template'){
  $url = PATH_SITE_TEMPLATE.'/images';
  //$path = $documentroot.URL::getCutPath().'/mg-templates/'.MG::getSetting('templateName').'/';
  $path = $documentroot.'/mg-templates/'.MG::getSetting('templateName').'/images';
}
if($_REQUEST['dir']=='uploads'){
  $url = SITE.'/uploads';
  $path = $documentroot.'/uploads';  
}
