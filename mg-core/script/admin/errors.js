...
var errors = (function() {
  ...
  return {
    ...
    showErrorBlock: function (errorText) {
      ...
      var errorBox = "" +
        "<div class='error-box'>" +
        "<a href='javascript:void(0)' class='close-notification link text-right' onclick='$(\".error-box\").remove()' style='float:right;'>Закрыть</a>" +
    ...
    getErrorText: function (errorText) {
      ...
      if(errorText==''){
        errorText = 'Причиной данного сообщения могло послужить <b>завершение сеанса работы пользователя</b>.\n\
              ...
              Или включите показ ошибок в файле index.php заменив строку Error_Reporting(0); на Error_Reporting(E_ALL);';
        errors.noneReport = 'style="display:none;"';
        lang.SORRY_ERROR = "<b>Произошла непредвиденная ошибка.</b> Пожалуйста, убедитесь что ваш web-сервер соответствует" +
          ...
          "xmlwriter, xmlreader, <a href='http://wiki.moguta.ru/ustanovka-sistemy/sistemnye-trebovaniya' >полный перечень системных требований</>";
      }
