...
class Import{
   ...
   * @return type
   */
  public function startUpload($rowId = false, $schemeType = 'default', $downloadLink=false) {    
    if(!$rowId){
      $rowId = 1;
    }
  ...
  // флаг для автоматического запуска создания миниатюр из скачанных картинок в процессе парсинга CSV
  function autoStartImageGen() {

   if(self::$downloadLink==true && HTTP_IMGCSV_DOWNLOAD==1) {
    return true;
   }
   return false;
