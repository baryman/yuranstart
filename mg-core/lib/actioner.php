...
//    exit();
  ...
  public function searchProduct() {
    ...
    $arr = $model->getListProductByKeyWord($_POST['keyword'], false, false, true, $_POST['mode']);
 ...
 /**
  ...
  public function startImport() {
    ...
    $this->data = $import->startUpload($_POST['rowId'], $_POST['schemeType'], $_POST['downloadLink']);
  ...
  public function saveSortableTable() {
    ...
    switch ($_POST['type']) {
      case 'page':
        $this->messageSucces = 'Порядок страниц изменен';
        $typeEntity = 'page';
        break;
      case 'category':
        $this->messageSucces = 'Порядок категорий изменен';
        $typeEntity = 'category';
        break;
    }
  ...
  public function setSeoForGroup() {
    ...
    if(!$result) {
      $this->messageError = 'У пользователя БД недостаточно прав на создание процедуры<br>Обратитесь в тех. поддержку хостинга!'; 
      return false;
    }
  ...
  public function changeActivityDP() {
    $this->messageSucces = 'Видимость изменена';
    $this->messageError = 'Произошла ошибка'; 
